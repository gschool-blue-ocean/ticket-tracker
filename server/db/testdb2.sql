...
INSERT INTO tickets (user_id, category, descrip, assigned, priority, ETA, email, status, campus_id, create_date ,resolved) VALUES(5, 'hardware', 'doesnt work', 'someone','Urgent','02/11/2023','test3@test.com','in progress', 1, '11/02/2022',null);
INSERT INTO tickets (user_id, category, descrip, assigned, priority, ETA, email, status, campus_id, create_date ,resolved) VALUES(6, 'hardware', 'doesnt work', 'someone','Priority','02/11/2023','test3@test.com','in progress', 1, '11/02/2022',null);
INSERT INTO tickets (user_id, category, descrip, assigned, priority, ETA, email, status, campus_id, create_date ,resolved) VALUES(7, 'hardware', 'doesnt work', 'someone','Routine','02/11/2023','test2@test.com','in progress', 2, '11/02/2022',null);
INSERT INTO tickets (user_id, category, descrip, assigned, priority, ETA, email, status, campus_id, create_date ,resolved) VALUES(8, 'hardware', 'doesnt work', 'someone','Minor','02/11/2023','test3@test.com','in progress', 1, '11/02/2022',null);
